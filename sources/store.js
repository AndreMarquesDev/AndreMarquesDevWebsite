    ...
    state: {
        ...
        projects: [
            ...
            },
            {
                ...
                myRole: `I was not the main developer in this project, I was brought in after it already started to help with creating new modules and fix some bugs. Therefore, my impact on it was not that big. It was, nonetheless, enough to get me into some technologies and frameworks that I had never work with, such as MongoDB and Heroku, as well as <a href="https://developers.google.com/web/progressive-web-apps" target="_blank" rel="noreferrer" aria-label="Progressive Web Apps by Google" class="alternativeLink">Progressive Web Apps</a> (although this one was already familiar to me).`,
                image: {
