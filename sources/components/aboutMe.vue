  ...
  data() {
    return {
      code: [
        {
          html:
            '<span class="yellow">const hireMe <span class="orange">=</span> (</span>education, skills, workExperience<span class="yellow">) => {</span>',
          identation: null
        },
        {
          html: "",
        ...
        {
          html:
            '<span class="orange">if</span> <span class="purple">(</span>skills <span class="orange">===</span> <span class="red">false</span><span class="purple">)</span> <span class="orange">return</span>;',
        ...
        {
          html:
            '<span class="yellow">const</span> aboutMe <span class="orange">=</span> <span class="purple">{</span>',
          identation: "identation1"
        },
        {
          html: `<span class="lightblue">name</span>: <span class="green">'André Marques'</span>,`,
        ...
        {
          html: `<span class="lightblue">city</span>: <span class="green">'Lisbon'</span>,`,
          identation: "identation2"
        },
        {
          html: `<span class="lightblue">country</span>: <span class="green">'Portugal'</span>,`,
          identation: "identation2"
        },
        {
        ...
        {
          html: `<span class="lightblue">role</span>: <span class="green">'Frontend Developer'</span>`,
          identation: "identation2"
        },
        {
        ...
        {
          html:
            '<span class="yellow">education</span><span class="purple">() {</span>',
          identation: "identation1"
        },
        {
          html: '<span class="red">2016</span> <span class="orange">&&</span>',
          identation: "identation2"
        },
        {
          html: `<span class="green">'Graduated in Law'</span>`,
          identation: "identation3"
        },
        {
          html: '<span class="red">2017</span> <span class="orange">&&</span>',
          identation: "identation2"
        },
        {
          html: `<span class="green">'Frontend and Responsive Web Development'</span>,`,
          identation: "identation3"
        },
        {
        ...
        {
          html: `<span class="green">'248h intensive course in HTML, CSS and JavaScript'</span>`,
          identation: "identation3"
        },
        {
          html: '<span class="purple">}</span>',
        ...
        {
          html:
            '<span class="yellow">skills</span><span class="purple">() {</span>',
          identation: "identation1"
        },
        {
          html:
            'mainSkills <span class="orange">=</span> <span class="lightblue">[</span>',
          identation: "identation2"
        },
        {
          html: `<span class="green">'JavaScript'</span>,`,
          identation: "identation3"
        },
        {
        ...
        {
          html: `<span class="green">'Vue'</span>,`,
          identation: "identation3"
        },
        {
        ...
        {
          html:
            'extras <span class="orange">=</span> <span class="lightblue">[</span>',
          identation: "identation2"
        },
        {
        ...
        {
          html:
            '<span class="yellow">workExperience</span><span class="purple">(</span>company, role, years, jobDescription, projects<span class="purple">) {</span>',
          identation: "identation1"
        },
        {
        ...
        {
          html: `years <span class="orange">=</span> <span class="red">2</span>;`,
          identation: "identation2"
        },
        {
          html: `jobDescription <span class="orange">=</span> <span class="green">'Worked at Fullsix for 2 years as a Frontend Developer. Dealt with high profile clients, since this is one of Portugal's biggest digital agencies. Worked in a team environment with constant communication with UI and UX teams, as well as backend developers.'</span>;`,
          identation: "identation2"
        },
        {
        ...
        {
          html:
            '<span class="yellow">currentJob</span><span class="purple">(</span>company, role, from<span class="purple">) {</span>',
          identation: "identation1"
        },
        {
        ...
        {
          html: `role <span class="orange">=</span> <span class="green">'Junior Software Engineer - UI'</span>;`,
          identation: "identation2"
        },
        {
        ...
        {
          html:
            '<span class="orange">return</span> education, skills, workExperience;',
          identation: "identation1"
        },
        {
          html: '<span class="purple">}</span>',
        ...
        {
          html:
            '<span class="orange">if</span> <span class="yellow">(</span>needNewWebsite <span class="orange">===</span> <span class="red">true</span><span class="yellow">) <a href="contact" class="link innerLink">hireMe()</a></span>;',
          identation: null
        }
      ]
    };
...
.aboutMe {
  ...
  code {
    ...
    p {
      ...
      &.identation2 {
        padding-left: $identation2;
      }

      &.identation3 {
        padding-left: $identation3;
      }
